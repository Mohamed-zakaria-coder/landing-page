...
const Home = () => {
    ...
    const products = [{
        ...
        description: "The combination of our constituents is refreshing and natural. Rich, rich vitamins, moisturizers, and protective substances hydrates and strengthens hair when applying. Hair feels fresh, shiney and soft after applying. The best solution for your damaged, dry, or weak hair..",
        sizes: [
            {
            size: "M",
            price: 80,
    ...
    return (
        <div className='home'>
            ...
            <div className='cover'>
                ...
                <p>Get the perfect combination of hair products for, get the best results instantly and make your hair shine.
</p>
